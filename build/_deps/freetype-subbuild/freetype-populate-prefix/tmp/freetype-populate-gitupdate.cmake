...
execute_process(
  COMMAND "D:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "VER-2-13-2"
  WORKING_DIRECTORY "D:/coding/HelloSFML/build/_deps/freetype-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/coding/HelloSFML/build/_deps/freetype-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/coding/HelloSFML/build/_deps/freetype-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
